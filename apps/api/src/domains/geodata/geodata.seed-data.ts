import { DecisionLayer, MapFeature, SearchTarget } from './geodata.models';

export const seedLayerCatalog: readonly DecisionLayer[] = [
  {
...
export const seedSearchTargets: readonly SearchTarget[] = [
  {
...
export const seedMapFeatures: readonly MapFeature[] = [
  {
...
export const seedDefaultSelectedLayerIds = ['property-boundaries', 'climate-risk'] as const;
export const seedDefaultSearchTargetId = 'sollentuna-sjoberg-5-5';
